...
public class SLR {
    ...
    /**
     * Returns the current token of the input. Discards possible space
     * characters.
     */
    ...
    /**
     * Push the character <code>c</code> on the stack. Actually push the state
     * reached in the LR automaton from the state <code>p</code> at top of the
     * stack under input <code>c</code>.
     *
    ...
    /**
     * Implements the Reduce() function. Pops the right side of production
     * <code>n</code> and pushes the left side (actually the states of the LR
     * automaton).
     *
    ...
    /**
     * Computes the SLR(0) shift table. The positive values correspond to the
     * shift part, the negative ones to the reduce part.
     */
