...
public class ICFA {
    ...
    /**
     * Computes a set transition in an ICFA as an array of sets indexed by the
     * letters. The complexity is <code>O(e log(n))</code> for an
     * <code>NFA</code> with <code>e</code> edges and <code>n</code> states.
     * Indeed, the set <code>s</code> has <code>O(n)</code> elements and each
     * insertion costs time <code>log(n)</code> using a <code>TreeSet</code> to
     * represent the sets <code>s</code> and <code>next(s, c)</code>.
     *
     ...
     * the list of sets of half edges realizing the determinization of the NFA.
     * The third argument is the resulting DFA. The exploration starts at the
     * element <code>s</code> of <code>t</code> with order <code>p</code>.
     *
    ...
    /**
     * The same as <code>explore</code> but with a transmission of the index of
     * the set <code>s</code> in the list <code>t</code>.
     */
    ...
    /**
     * The same as <code>toIDFA</code> but with an implementation of the set of
     * states of the resulting <code>IDFA</code> via a <code>HashMap</code>. The
     ...
     * resulting in a <code>IDFA</code> with <code>m</code> states.
     */
    ...
    /**
     * Computes the deterministic automaton (IDFA) obtained by reversing the
     * edges of a codeterministic automaton (ICFA). Complexity <code>O(e)</code>
    ...
    /**
     * Implements the determinization algorithm. The sets of states created are
     * represented by an object of the class
     * <a href=  "/usr/local/j2sdk1.4.2_03/docs/api/java/util/TreeSet.html">
     * TreeSet</a>. The set of subsets created is stored as a list using the
     * class
     * <a href=  "/usr/local/j2sdk1.4.2_03/docs/api/java/util/LinkedList.html">
     * LinkedList </a>. Implements the function <code>NFAtoDFA</code> of Section
     * 1.3.3.
     */
