...
public class Grammar {
    ...
    public Set[] derive;
    /**
     * The variables. The set of variables is supposed to coincide with the set
     * of left sides of productions.
     */
    public Alphabet variables;
    /**
     * The terminals. The terminal characters represent tokens of the lexical
     * analysis.
     */
    ...
    /**
     * Implements <code>Epsilon()</code>. Initializes the boolean array epsilon
     * of erasable symbols.
     */
    public void epsilon() {
        int k;
     ...
     * @return the sucessors of <code>v</code> in the graph First (terminals and
     * variables).
     */
    ...
    /**
     * The modified version of the <code>ETF</code> grammar which is LL(1) :<br>
     * <code> E -> Te</code><br>
     * <code> e -> +Te | ""</code><br>
     * <code> T -> Ft</code><br>
     * <code> t -> *Ft | ""</code><br>
