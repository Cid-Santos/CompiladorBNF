...
public class IDFA {
    ...
    public int initial;
    /**
     * The array of terminal states. State <code>p</code> is terminal if
     * <code>terminal[p] = 1</code>.
     */
    public Set terminal;
    /**
     * The alphabet.
    ...
    /**
     * Computes the direct product of the IDFA <code>a</code> and
     * <code>b</code>. Both IDFA share the same alphabet.
     */
    ...
    /**
     * True if the automaton is a DAWG, i.e. if the graph of the automaton is
     * acyclic.
     */
    ...
    /**
     * A classical depth-first search. Complexity <code>O(m)</code> where
     * <code>m</code> is the number of edges.
     *
     * @return true if the graph reachable from state <code>p>/code> is
     * acyclic.
     * @param p the starting state.
     * @param mark an array of marks interpreted as 0 = unmarked 1 = active 2 =
     * terminated.
     */
    ...
    /**
     * Tests wheter the states are on a successful path of the automaton. Uses a
     * depth first search from state <code>p</code> to fill the boolean array
     * <code>isOn</code>.
     *
     * @param p a state
     * @param isOn A boolean array with <code>isOn[p] = true</code> if there is
     * a path to a terminal state from state <code>p</code>.
     */
    ...
    /**
     * Gives the new names of the states after eliminating those such that
     * <code>b[i] = false</code>
     *
     * @return the integer array <code>index</code> where
     * <code>index[i] = n</code> if <code>i</code> is the nth index such that
     * <code>b[i] = true</code>.
     */
    ...
    /**
     * A call to <code>enumerate(isOn)</code> returns the number of states of
     ...
     * <code>O(k n)</code> for an <code>IDFA</code> with <code>k</code> letters
     * and <code>n</code> states.
     */
    ...
    /**
     * Adds to the automaton an edge from <code>p</code> to <code>q</code>
     * labeled <code>alphabet.toChar(a)</code> if it does not exist already.
     * Complexity
     * <code>O(k n)</code> for an <code>IDFA</code> with <code>k</code> letters
     * and <code>n</code> states.
     */
    ...
    /**
     * Sorts the outgoing edges in alphabetic order. Complexity
     * <code> O(u+n+e)</code>
     */
    ...
    /**
     * Computes the width (or outdegree) of each state. Complexity
     * <code>O(n + e)</code>.
     *
     * @return the array <code>wid</code> of widths. The value of
     * <code>wid[p]</code> is the number of edges going out of <code>p</code>.
     */
    ...
    /**
     * Returns the array of heigths. The heigth of a state <code>p</code> is the
     * maximal length of a path starting at <code>p</code>.
     *
     * @return the array <code>heigth</code> of heigths.
     */
    public int[] heigths() {
     ...
     * @return the array <code>hh</code> of numbers of states by heigth. One has
     * <code>hh[p]=k</code> if there are <code>k</code> states at heigth
     * <code>k</code>.
     */
...
//     }
    ...
    /**
     * Computes the codeterministic automaton (ICFA) obtained by reversing the
     * edges of a deterministic automaton (IDFA). Complexity <code>O(e)</code>
