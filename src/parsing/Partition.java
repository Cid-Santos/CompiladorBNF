...
public class Partition implements Cloneable {
    ...
    /**
     * Creates the partition with one class (with name 0) of
     * <code>0,...,n</code>
     */
    ...
    /**
     * Transfers <code>q</code> from the class <code>src</code> to the class
     * <code>dest</code>.
     */
    ...
    /**
     * Transfers the elements of the list <code>list</code> from the class
     * <code>src</code> to the class <code>dest</code>.
     */
    ...
    /**
     * breaks the class <code>src</code> using the block <code>list</code>.
     */
