...
public class DFT extends DFA {
     ...
     * <code>w</code> (without regard to terminal states and a possible terminal
     * output).
     */
    ...
    /**
     * Returns the composition of the DFT <code>a</code> and <code>b</code>. The
     * method is a particular case of the composition of NFT. The corresponding
     * transduction applies first <code>a</code> and then <code>b</code>. The
     * states are pairs <code>(q,p)</code> of a state of
     * <code>b</code> and a state of <code>a</code> coded by the integer
     * <code>q * a.nbStates + p</code>.
     */
    ...
    /**
     * Returns the longest common prefix of the strings <code>s</code> and
     * <code>t</code>.
     *
     * @param s a string
     * @param t a string
     * @return the longest common prefix of the strings <code>s</code> and
     * <code>t</code>.
     */
    ...
    /**
     * Realizes the iteration m=Um+v with operations in the semiring
     * <code>(lcp,.,0,\e)</code> where
     * <code>m</code> is a vector of strings, <code>U</code> the matrix of
     * outputs and <code>v</code> the vector of terminal outputs.
     *
     ...
     * <code>lcp[p]</code> is the longest common prefix of the strings
     * <code>star(p,w)</code>
     *
    ...
    /**
     * Returns the partition intersection of <code>table1 </code> and
     * <code>table2</code>.
     *
    ...
    public static void main(String[] args) {
        ...
        DFT s = compose(r, r);
        System.out.println(s.star(0, "abbaa"));
